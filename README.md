...
```
*(Note: If the pre-trained model files (`random_forest.pkl`, `label_encoder.pkl`, `symptoms_list.pkl`) are missing, you can regenerate them by running `python model/train.py` from within the backend directory).*
