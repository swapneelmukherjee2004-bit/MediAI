        ...
        return (
            <div style={{ height: '100%', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column', gap: '1rem', background: '#111827', color: '#9ca3af', textAlign: 'center', padding: '2rem' }}>
                ...
                <p style={{ maxWidth: '400px' }}>
                    The Epidemiology Dashboard strictly tracks individual diseases. Please generate a RandomForest symptom prediction on the Diagnose page first to visualize its global hotspots.
                </p>
            </div>
        );
    }
